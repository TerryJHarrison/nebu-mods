atom ('mod.info', {
	...
	See [url=https://steamcommunity.com/sharedfiles/filedetails/?id=2814759271]Organized Tabs: Food (by target)[/url] to sort the new tabs by production target class instead (only one Organized Tabs: Food mod should be enabled).
