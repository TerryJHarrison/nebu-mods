atom ('mod.info', {
	...
	See https://steamcommunity.com/sharedfiles/filedetails/?id=2814758816 to sort the new tabs by production target class instead (only one Organized Tabs: Industry mod should be enabled).
