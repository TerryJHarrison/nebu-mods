atom ('mod.info', {
	title = "Shine AoE: +3",
	description = [[
	Increase the tile range of shrine effects by 3 squares.
	...
	Source code can be found on [url=https://github.com/TerryJHarrison/nebu-mods/tree/main/mods/shrine_aoe_plus_3]GitHub[/url]
	]],
	author = "TJ Harrison",
