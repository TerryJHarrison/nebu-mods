atom ('mod.info', {
	title = "Shine AoE: +2",
	description = [[
	Increase the tile range of shrine effects by 2 squares.
	...
	Source code can be found on [url=https://github.com/TerryJHarrison/nebu-mods/tree/main/mods/shrine_aoe_plus_2]GitHub[/url]
	]],
	author = "TJ Harrison",
