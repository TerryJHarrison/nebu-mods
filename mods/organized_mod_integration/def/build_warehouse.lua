...
if array_contains(active_game_mods(), 'big_stockpile') then
	buildings = {
		'big_stockpile::build.big_stockpile.1',
		'big_stockpile::build.big_stockpile.2',
		'big_stockpile::build.big_stockpile.3',
		'big_stockpile::build.big_stockpile.4',
		'big_stockpile::build.big_stockpile.5',
		'big_stockpile::build.big_stockpile.6',
		'big_stockpile::build.big_stockpile.7',
		'big_stockpile::build.big_stockpile.8',
		'big_stockpile::build.big_stockpile.9',
		'big_stockpile::build.big_stockpile.10',
		'big_stockpile::build.big_stockpile.11',
		'big_stockpile::build.big_stockpile.12',
		'big_stockpile::build.big_stockpile.13',
		'big_stockpile::build.big_stockpile.14',
		'big_stockpile::build.big_stockpile.15',
		'big_stockpile::build.big_stockpile.16',
		'big_stockpile::build.big_stockpile.17',
		'big_stockpile::build.big_stockpile.sc',
		'big_stockpile::build.big_stockpile.sc_w',
	}
